...
char	*version[] =
{
	"9wm version 1.2, Copyright (c) 1994-1996 David Hogan, Copyright (c) 2014 Helmuth Schmelzer in Bugfixes, and etc", 0,
};
...
usage()
{
	fprintf(stderr, "usage: 9wm [-nostalgia] [-grey] [-debug] [-version] [-font fname] [-term prog] [exit|restart]\n");
	exit(1);
}
